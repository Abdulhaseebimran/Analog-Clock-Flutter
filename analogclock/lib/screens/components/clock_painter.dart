...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Minute Line
    canvas.drawLine(center , Offset(minX, minY), Paint()..color = Theme.of(context).accentColor
    ..style = PaintingStyle.stroke..strokeWidth = 10);

    // hours line
    // Offset value is random
    canvas.drawLine(center, Offset(hourX, hourY) , Paint()..color = Theme.of(context).colorScheme.secondary
    ..style = PaintingStyle.stroke..strokeWidth = 10);
